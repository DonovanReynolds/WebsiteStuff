...
else
{
   ...
   while($row = $result->fetch_assoc())
   {
      ...
      returnWithSuccess($fetchedFirstName, $fetchedLastName, $fetchedEmail, $fetchedPhone);
...
{
   $retValue = array("FirstName" => $firstName, "LastName" => $lastName, "Email" => $email, "Phone" => $phone);
